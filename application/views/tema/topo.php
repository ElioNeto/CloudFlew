...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="pull-right"><a href="https://github.com/ElioNeto/" target="_blank"><i class="icon icon-asterisk"></i> <span class="text">Versão: <?php echo $this->config->item('app_version'); ?></span></a></li>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="https://github.com/ElioNeto/" target="_blank"><?php echo date('Y'); ?> &copy; Cloud Flew - Elio Neto </a></div>
</div>
<!--end-Footer-part-->
